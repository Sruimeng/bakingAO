...
int main(int argc, const char** argv)
{
	...
	try {
		...
		timer.start();
		uautil::Scene scene;
		uautil::loadScene(gltfFilename, &scene);
		//
		// ��������
		//
		...
		//
		/* optix::Context context = Context::create(contextType);
		...
		bake::modelToView(&scene, scene.m_num_meshes, vertex_ao, scene.bbox_min, scene.bbox_max, blocker_meshes);
		printTimeElapsed(timer);
